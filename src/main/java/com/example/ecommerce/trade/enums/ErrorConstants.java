...
public interface ErrorConstants {
    ErrorCode CART_NOT_FOUND = new ErrorCode("Cart not found", NOT_FOUND.value());
    ErrorCode ORDER_NOT_FOUND = new ErrorCode("Order not found", NOT_FOUND.value());
    ...
    ErrorCode LINE_ITEM_NOT_FOUND = new ErrorCode("LineItem not found", NOT_FOUND.value());
}
