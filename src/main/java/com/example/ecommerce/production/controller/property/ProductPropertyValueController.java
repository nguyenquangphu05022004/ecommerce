package com.example.ecommerce.production.controller.property;
...
import com.example.ecommerce.production.service.property.ProductPropertyValueService;
...
@RestController
@RequestMapping("/api/product-property-values")
